...
public:
  ...
  void Init(const index_t &width, const index_t &height, const int &idx = 0, const multi_index_t &t_idx = multi_index_t(0), const multi_index_t &t_dim = multi_index_t(0)); // set window position automatically fix
