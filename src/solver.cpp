...
{
	// safety check
	if (((pressure->getGeometry()->Size()[0] % 2) != 0) || ((pressure->getGeometry()->Size()[0] % 2) != 0)){
		throw std::runtime_error("MGSolver: size not even!");
	}
